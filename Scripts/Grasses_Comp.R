...
list.of.packages <- c("tidyverse", "vegan", "agricolae", "extrafont", 
                      ...
                      "vegan", "labdsv", "tables", "plotrix", "reshape2")
...
Data = filter(Data, Species == "Aristida beyrichiana" | Species == "Andropogon virginicus" |
              Species == "Eragrostis spectabilis" | Species == "Aristida beyrichiana")
...
Box22 = 
  ...
  stat_pvalue_manual(tukey_22,size = 8, bracket.size = 1, hide.ns = T, bracket.nudge.y = -100,
)+
...
Box23 = 
  ...
  geom_point(aes(fill=Treatment), 
             position = position_jitterdodge(), size = 2, alpha = 0.5) +
  stat_pvalue_manual(tukey_23,size = 8, bracket.size = 1, hide.ns = T, bracket.nudge.y = -100)+
  scale_color_manual(labels=c('BH', 'BM', 'LH', 'LM', 'W', "C"),
                     values=c("#663333", "#FF9966", "#006600", "#99FF99", "#CC0000", "#330099")) +
  scale_fill_manual(labels=c('BH', 'BM', 'LH', 'LM', 'W', "C"),
                    values=c("#663333", "#FF9966", "#006600", "#99FF99", "#CC0000", "#330099")) +
  labs(subtitle = get_test_label(anova_23, detailed = TRUE),
